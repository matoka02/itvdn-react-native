      ...
      <View style={styles.topRight}>
        <TouchableOpacity onPress={toggleDropdown} style={styles.icon}>
          {dropdownVisible ? (
            ...
            <Image
              style={styles.logo}
              source={require('../../assets/images/earth-icon.png')}
            />
          )}
        </TouchableOpacity>
        {dropdownVisible && (
...
export default I18nLocalizationComponent;
